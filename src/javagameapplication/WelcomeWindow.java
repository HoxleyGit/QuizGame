...
public class WelcomeWindow extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Witaj! Podaj swój nick :");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        openWindow.getGameWindow().getGameController().getPlayer().setNick(jTextField1.getText());
        openWindow.getGameWindow().getGameController().getPlayer().setScore(0);
        openWindow.getPlayerPanel().refresh();
        setVisible(false);
